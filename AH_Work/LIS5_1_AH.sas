...
* Client: XXXX                                                           
* Project:  COVID-19 AA                                                   
* Program: LIS5_1_AH.SAS  
*
* Program Type: Listing
*
* Purpose: To produce 16.2.1.5 Abnormal Biochemistry Values
* Usage Notes: 
*
* SAS® Version: 9.4
* Operating System:                    
...
TITLE3 J=C "16.2.1.5 Abnormal Biochemistry Values";

FOOTNOTE1 J=L "G:\COVID08_042023\AH_Work\LIS5_1_AH.SAS";

OPTIONS ORIENTATION=LANDSCAPE;
ODS ESCAPECHAR='^';
ODS RTF FILE="G:\COVID08_042023\OUTPUTS\L_16_2_1_5.RTF" STYLE=styles.test;
